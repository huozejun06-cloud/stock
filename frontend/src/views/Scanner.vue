    ...
    <div class="mx-auto flex gap-4" style="max-width: var(--space-container); height: calc(100vh - 120px)">
      ...
      <aside ref="filterRef" class="glass-card p-5 shrink-0 overflow-y-auto" style="width: 260px; opacity: 0">
        ...
        <div class="space-y-4">
          ...
          <button @click="runScan" :disabled="scanning" class="w-full cta-orange text-sm py-2.5 rounded-lg font-semibold transition-all duration-300 hover:shadow-glow-orange" style="font-family: var(--font-body)">
            开始扫描
          </button>
        </div>
...
const stocks = ref(Array.from({ length: 50 }, (_, i) => {
